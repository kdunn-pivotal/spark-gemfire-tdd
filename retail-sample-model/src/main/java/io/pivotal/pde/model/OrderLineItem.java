...
public class OrderLineItem {
    ...
    public OrderLineItem(String order_id, String order_item_id, String product_name, Float item_quantity, Float item_price) {
